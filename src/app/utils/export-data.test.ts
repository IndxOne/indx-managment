...
describe("buildExportPayload", () => {
  it("reprend l'état complet avec l'horodatage et le numéro de format, sans le hash utilisateur", () => {
    const state = {
      ...EMPTY_STATE,
      workspaces: [{ id: "w1" } as never],
      carnetNotes: [{ id: "n1", text: "idée", createdAt: "2026-09-01T00:00:00.000Z" }],
    };
    const payload = buildExportPayload(state, new Date("2026-09-10T12:00:00.000Z"));
