...
describe("appReducer — action/create (Échéance, réalignement prototype v2.2 §3)", () => {
  ...
  it("avec schedule fourni (Échéance choisie dans AddActionSheet), l'action créée le porte directement", () => {
    const next = appReducer(stateWithWorkspace(), {
      type: "action/create",
      input: {
        workspaceId: "w1",
